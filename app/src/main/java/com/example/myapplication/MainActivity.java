        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(), "Name must not contain a number", Toast.LENGTH_SHORT).show();
                    return;
                } else if (Integer.parseInt(age.getText().toString()) > 150 || Integer.parseInt(age.getText().toString()) <= 0) {
